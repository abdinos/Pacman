                ...
                for (int j=0;j<getMapData()[i].length;j++){
                    ...
                    switch (element){
                        case "W":
                            ...
                            System.out.println(img.getWidth(null)+"********"+width);
                            System.out.println(img.getHeight(null)+"$$$$$$$$"+height);
        ...
        //                    entity1.setWidth(gameCore.graphicEngine.getBasePanel().getWidth()/getMapData()[0].length-5);
         //                   entity1.setHeight(gameCore.graphicEngine.getBasePanel().getHeight()/getMapData().length-5);
                        ...
                        case "F":
                            ...
                            System.out.println("FRUITY"+x2+ "yyy"+ y2);
                            break;
                        case "P":
                            ...
                            entity3.setId(1991);
                            System.out.println("PAAAAC"+x3+"PPPPP"+y3);
